...
public class MainActivity extends AppCompatActivity {
     ...
     */
    private ArrayList<LocationEntry> mLocations;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // List
        mLocations = new ArrayList<LocationEntry>();
        ...
        // Set up recycleview
        //mLocationHistory.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mLocationHistory.setLayoutManager(mLayoutManager);
        mAdapter = new LocationHistoryViewAdapter(mLocations);
        mLocationHistory.setAdapter(mAdapter);
    ...
    /**
     * Add a location to the list of all locations received.
     */
    ...
    private void createLocationCallback() {
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                updateLocationUI();
                addLocationToList(mCurrentLocation, mLastUpdateTime);
            }
        };
    }
